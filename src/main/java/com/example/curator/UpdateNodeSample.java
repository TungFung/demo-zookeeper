...
public class UpdateNodeSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.create()
                ...
                .forPath(nodePath, "this is an example".getBytes());

        System.out.println("旧节点内容:" + new String(client.getData().forPath(nodePath)));

        //更新
        client.setData().forPath(nodePath, "this is new content".getBytes());
